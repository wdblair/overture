...
fun imu_cal_add (x: int, y: int, z: int): void = "ext#"
fun imu_cal_x (): int = "ext#"
fun imu_cal_y (): int = "ext#"
fun imu_cal_z (): int = "ext#"
...
fun calibrate (i: &vec3, r0: &vec3? >> vec3): void = "ext#calibrate"
fun subtract (a: &vec3, b: &vec3, r0: &vec3? >> vec3): void = "ext#subtract"
